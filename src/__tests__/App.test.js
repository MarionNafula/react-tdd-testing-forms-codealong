...
test("'Contact Info' text box initialy displayed a placeholder value of 'email address'", () => {
  render(<App />);

  expect(screen.getByPlaceholderText(/email address/i)).toBeInTheDocument();
})

test("the page shows information the user type into the contact form field", () => {
  render(<App />);
